...
import (
	...
	"github.com/kubeshop/testkube-operator/pkg/event/dummy"
)
...
func newExampleTestEvent1() events.Event {
	return events.Event{
		Id:            "eventID1",
		Type_:         events.EventStartTest,
		TestExecution: &testexecutionv1.TestExecution{},
		// events.NewExecutionWithID("executionID1", "test/test", "test"),
	}
}

func newExampleTestEvent2() events.Event {
	return events.Event{
		Id:            "eventID2",
		Type_:         events.EventStartTest,
		TestExecution: &testexecutionv1.TestExecution{},
		// events.NewExecutionWithID("executionID2", "test/test", "test"),
	}
}
