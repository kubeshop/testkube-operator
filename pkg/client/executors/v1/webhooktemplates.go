...
//go:generate mockgen -destination=./mock_webhooktemplates.go -package=executors "github.com/kubeshop/testkube-operator/pkg/client/executors/v1" WebhookTemplatesInterface
