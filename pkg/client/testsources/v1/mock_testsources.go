...
//
//	mockgen -source=./testsources.go -destination=./mock_testsources.go -package=testsources github.com/kubeshop/testkube-operator/pkg/client/testsources/v1 Interface
//
...
import (
	...
	v1 "github.com/kubeshop/testkube-operator/api/testsource/v1"
...
func (mr *MockInterfaceMockRecorder) Create(testSource any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{testSource}, options...)
...
func (mr *MockInterfaceMockRecorder) Update(testSource any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{testSource}, options...)
