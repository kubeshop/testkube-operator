...
//
//	mockgen -destination=./mock_templates.go -package=templates github.com/kubeshop/testkube-operator/pkg/client/templates/v1 Interface
//
...
import (
	...
	v1 "github.com/kubeshop/testkube-operator/api/template/v1"
