...
//go:generate mockgen -destination=./mock_testworkflowtemplates.go -package=v1 "github.com/kubeshop/testkube-operator/pkg/client/testworkflows/v1" TestWorkflowTemplatesInterface
