...
//
//	mockgen -source=./rest.go -destination=./mock_rest.go -package=v3 github.com/kubeshop/testkube-operator/pkg/client/testsuites/v3 RESTInterface
//
...
func (mr *MockRESTInterfaceMockRecorder) WatchUpdates(ctx, environmentId, includeInitialData any) *gomock.Call {
