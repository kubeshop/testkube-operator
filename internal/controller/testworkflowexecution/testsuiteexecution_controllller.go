...
//+kubebuilder:rbac:groups=tests.testkube.io,resources=testworkflowexecutions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tests.testkube.io,resources=testworkflowexecutions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tests.testkube.io,resources=testworkflowexecutions/finalizers,verbs=update
