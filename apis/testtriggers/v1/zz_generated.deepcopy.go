...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestTriggerCRGroupVersionResource) DeepCopyInto(out *TestTriggerCRGroupVersionResource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestTriggerCRGroupVersionResource.
func (in *TestTriggerCRGroupVersionResource) DeepCopy() *TestTriggerCRGroupVersionResource {
	if in == nil {
		return nil
	}
	out := new(TestTriggerCRGroupVersionResource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestTriggerSpec) DeepCopyInto(out *TestTriggerSpec) {
	*out = *in
	...
	out.CustomResource = in.CustomResource
