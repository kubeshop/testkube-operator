...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExecutionResultStep) DeepCopyInto(out *ExecutionResultStep) {
	*out = *in
	in.StartTime.DeepCopyInto(&out.StartTime)
	in.EndTime.DeepCopyInto(&out.EndTime)
	if in.Assertions != nil {
		in, out := &in.Assertions, &out.Assertions
		*out = new(ExecutionResultStepAssertion)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExecutionResultStep.
func (in *ExecutionResultStep) DeepCopy() *ExecutionResultStep {
	if in == nil {
		return nil
	}
	out := new(ExecutionResultStep)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExecutionResultStepAssertion) DeepCopyInto(out *ExecutionResultStepAssertion) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExecutionResultStepAssertion.
func (in *ExecutionResultStepAssertion) DeepCopy() *ExecutionResultStepAssertion {
	if in == nil {
		return nil
	}
	out := new(ExecutionResultStepAssertion)
