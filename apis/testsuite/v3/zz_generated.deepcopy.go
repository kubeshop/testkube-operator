...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestSuiteStepTest) DeepCopyInto(out *TestSuiteStepTest) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestSuiteStepTest.
func (in *TestSuiteStepTest) DeepCopy() *TestSuiteStepTest {
	if in == nil {
		return nil
	}
	out := new(TestSuiteStepTest)
