...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestScriptSpec) DeepCopyInto(out *TestScriptSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestScriptSpec.
func (in *TestScriptSpec) DeepCopy() *TestScriptSpec {
	if in == nil {
		return nil
	}
	out := new(TestScriptSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestSpec) DeepCopyInto(out *TestSpec) {
	*out = *in
	if in.Scripts != nil {
		...
		*out = make([]TestScriptSpec, len(*in))
		copy(*out, *in)
	}
}
