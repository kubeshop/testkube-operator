...
//go:generate mockgen -destination=./mock_executors.go -package=executors "github.com/kubeshop/testkube-operator/client/executors/v2" Interface
type Interface interface {
	List(selector string) (*executorv2.ExecutorList, error)
	Get(name string) (*executorv2.Executor, error)
	GetByType(executorType string) (*executorv2.Executor, error)
	Create(executor *executorv2.Executor) (*executorv2.Executor, error)
	Delete(name string) error
	Update(executor *executorv2.Executor) (*executorv2.Executor, error)
...
func (s ExecutorsClient) List(selector string) (*executorv2.ExecutorList, error) {
	list := &executorv2.ExecutorList{}
...
func (s ExecutorsClient) Get(name string) (*executorv2.Executor, error) {
	executor := &executorv2.Executor{}
...
func (s ExecutorsClient) GetByType(executorType string) (*executorv2.Executor, error) {
	list := &executorv2.ExecutorList{}
...
func (s ExecutorsClient) Create(executor *executorv2.Executor) (*executorv2.Executor, error) {
...
func (s ExecutorsClient) Update(executor *executorv2.Executor) (*executorv2.Executor, error) {
...
func (s ExecutorsClient) DeleteByLabels(selector string) error {
	...
	u.SetKind("Executor")
	u.SetAPIVersion("executor.testkube.io/v2")
