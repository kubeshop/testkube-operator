...
// Source: github.com/kubeshop/testkube-operator/client/executors/v2 (interfaces: Interface)
...
func (m *MockInterface) Create(arg0 *v2.Executor) (*v2.Executor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0)
	ret0, _ := ret[0].(*v2.Executor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInterface) Get(arg0 string) (*v2.Executor, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) GetByType(arg0 string) (*v2.Executor, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(arg0 string) (*v2.ExecutorList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", arg0)
	ret0, _ := ret[0].(*v2.ExecutorList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInterface) Update(arg0 *v2.Executor) (*v2.Executor, error) {
	m.ctrl.T.Helper()
