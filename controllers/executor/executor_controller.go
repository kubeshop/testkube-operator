...
//+kubebuilder:rbac:groups=executor.kubetest.io,resources=executors,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=executor.kubetest.io,resources=executors/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=executor.kubetest.io,resources=executors/finalizers,verbs=update
