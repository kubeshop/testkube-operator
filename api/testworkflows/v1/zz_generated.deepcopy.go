...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestWorkflowPvcConfig) DeepCopyInto(out *TestWorkflowPvcConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestWorkflowPvcConfig.
func (in *TestWorkflowPvcConfig) DeepCopy() *TestWorkflowPvcConfig {
	if in == nil {
		return nil
	}
	out := new(TestWorkflowPvcConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestWorkflowSpec) DeepCopyInto(out *TestWorkflowSpec) {
	*out = *in
	...
	if in.Pvcs != nil {
		...
		*out = make(map[string]TestWorkflowPvcConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
