...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContentTransfer) DeepCopyInto(out *ContentTransfer) {
	*out = *in
	if in.Files != nil {
		in, out := &in.Files, &out.Files
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContentTransfer.
func (in *ContentTransfer) DeepCopy() *ContentTransfer {
	if in == nil {
		return nil
	}
	out := new(ContentTransfer)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SpawnInstructionBase) DeepCopyInto(out *SpawnInstructionBase) {
	*out = *in
	...
	if in.Transfer != nil {
		...
		*out = make([]ContentTransfer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
