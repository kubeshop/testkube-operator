...
func (in *StepExecute) DeepCopyInto(out *StepExecute) {
	*out = *in
	if in.Tarball != nil {
		in, out := &in.Tarball, &out.Tarball
		*out = make(map[string]StepExecuteTarball, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StepExecuteTarball) DeepCopyInto(out *StepExecuteTarball) {
	*out = *in
	if in.Files != nil {
		in, out := &in.Files, &out.Files
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StepExecuteTarball.
func (in *StepExecuteTarball) DeepCopy() *StepExecuteTarball {
	if in == nil {
		return nil
	}
	out := new(StepExecuteTarball)
	in.DeepCopyInto(out)
	return out
}
