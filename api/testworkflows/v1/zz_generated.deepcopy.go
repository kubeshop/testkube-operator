...
func (in *StepExecute) DeepCopyInto(out *StepExecute) {
	*out = *in
	if in.Tarball != nil {
		...
		*out = make(map[string]StepExecutePack, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StepExecutePack) DeepCopyInto(out *StepExecutePack) {
	*out = *in
	if in.Files != nil {
		in, out := &in.Files, &out.Files
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StepExecutePack.
func (in *StepExecutePack) DeepCopy() *StepExecutePack {
	if in == nil {
		return nil
	}
	out := new(StepExecutePack)
	in.DeepCopyInto(out)
	return out
}
