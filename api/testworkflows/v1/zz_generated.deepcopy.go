...
func (in *StepArtifacts) DeepCopyInto(out *StepArtifacts) {
	*out = *in
	if in.ExecutedTestWorkflowPosition != nil {
		in, out := &in.ExecutedTestWorkflowPosition, &out.ExecutedTestWorkflowPosition
		*out = new(TestWorkflowStepExecuteTestWorkflowPosition)
		**out = **in
	}
	if in.WorkingDir != nil {
		in, out := &in.WorkingDir, &out.WorkingDir
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestWorkflowStepExecuteTestWorkflowPosition) DeepCopyInto(out *TestWorkflowStepExecuteTestWorkflowPosition) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestWorkflowStepExecuteTestWorkflowPosition.
func (in *TestWorkflowStepExecuteTestWorkflowPosition) DeepCopy() *TestWorkflowStepExecuteTestWorkflowPosition {
	if in == nil {
		return nil
	}
	out := new(TestWorkflowStepExecuteTestWorkflowPosition)
