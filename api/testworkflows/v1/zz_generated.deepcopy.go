...
func (in *IndependentStep) DeepCopyInto(out *IndependentStep) {
	*out = *in
	...
	if in.Parallel != nil {
		...
		*out = new(StepIndependentParallel)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StepIndependentParallel) DeepCopyInto(out *StepIndependentParallel) {
	*out = *in
	in.StepExecuteStrategy.DeepCopyInto(&out.StepExecuteStrategy)
	if in.Transfer != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StepIndependentParallel.
func (in *StepIndependentParallel) DeepCopy() *StepIndependentParallel {
	if in == nil {
		return nil
	}
	out := new(StepIndependentParallel)
