...
func (in *TestWorkflowRunningContext) DeepCopyInto(out *TestWorkflowRunningContext) {
	*out = *in
	...
	if in.Caller != nil {
		...
		*out = new(TestWorkflowRunningContextCaller)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestWorkflowRunningContextCaller) DeepCopyInto(out *TestWorkflowRunningContextCaller) {
	*out = *in
	if in.CallerResourceType != nil {
		in, out := &in.CallerResourceType, &out.CallerResourceType
		*out = new(TestWorkflowRunningContextCallerResourceType)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestWorkflowRunningContextCaller.
func (in *TestWorkflowRunningContextCaller) DeepCopy() *TestWorkflowRunningContextCaller {
	if in == nil {
		return nil
	}
	out := new(TestWorkflowRunningContextCaller)
